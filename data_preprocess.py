...
if __name__ == "__main__":
    ...
    file_name = "checkin-atl.tsv"
    if file_name not in os.listdir(args.data_path):
    ...
    if args.data_path == './data/geolife':
        ...
        df = pd.read_csv(os.path.join(args.data_path, file_name), sep='\t')
    ...
    # group user's trajectory by date
    """
        {
            [0]:{
                ['2020-09-15']:{
                    'type': array(['Restaurant', 'Apartment', 'Restaurant', 'Apartment'],
                    'coor': array([[ 743427.01929774, 3738206.70260829],
                                    [ 743575.95237235, 3738074.4563182 ],
                                    [ 743427.01929774, 3738206.70260829]
                                    [ 743575.95237235, 3738074.4563182 ]],
